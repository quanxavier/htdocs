...
if(!$fgmembersite->CheckLogin())
{
 ...
 $dbhost = "localhost";
   ...
   echo"This camper has all forms filled out";
        }else{
         $fgmembersite->Delete_Camper();
...
<body>
	...
	<header id="header">
		<hgroup>
                    <h1 class="site_title"><a href="edit_forms.php">Forms Editor</a></h1>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Menu</h3>
		<ul class="toggle">
                    <li class="icn_new_article"><a href="userhome.php">User Home</a></li>
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">Choose the form you need to edit. Note you cannot edit birth date, gender, or age.</h4>
			...
			<div class="module_content">
                            ...
                            <a href="camper_info_1.php"><img class='' src='images/form1.PNG' width='90%' height="600"  alt=''/></a>
			...
			<div class="module_content">
                            ...
                            <a href="camp_week_1.php"><img class='' src='images/form2.PNG' width='90%' height="600" alt=''/></a>
     ...
     <article class="module width_weeks">
			...
			<div class="module_content">
                            ...
                            <a href="Camp_Health_Form_1.php"><img class='' src='images/form3.PNG' width='90%' height="600" alt=''/></a>
     ...
     <article class="module width_weeks">
			...
			<div class="module_content">
                            ...
                            <a href="Consent_Form_1.php"><img class='' src='images/form4.PNG' width='90%' height="600" alt=''/></a> 
