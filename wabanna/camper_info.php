...
<input type='hidden'  class='spmhidip' FirstName='<?php echo $fgmembersite->GetSpamTrapInputName(); ?>' />
...
<div id='label_container'>
               ...
               <div id='Age_container'>
                  <input type='text' name='Age' id='Age' size='20' class='sfm_textbox'/>
               </div>
               ...
               <div id='confirm_email_f_container'>
                  <input type='text' name='confirm_email_f' id='confirm_email_f' size='20' class='sfm_textbox'/>
               </div>
               ...
               <div id='county_f_container'>
                  <input type='text' name='county_f' id='county_f' size='20' class='sfm_textbox'/>
               </div>
               ...
               <div id='confirm_email_m_container'>
                  <input type='text' name='confirm_email_m' id='confirm_email_m' size='20' class='sfm_textbox'/>
               </div>
               ...
               <div id='county_m_container'>
                  <input type='text' name='county_m' id='county_m' size='20' class='sfm_textbox'/>
               </div>
               ...
               <div id='Reset_container'>
                  <input type='button' name='Reset' value='Reset' onclick='sfm_clear_form(&#039;form#campinfo&#039;)' id='Reset'/>
               </div>
               <div id='vert_line'></div>
               <div id='box_element2'></div>
            </div>
         </div>
<div class='sfm_cr_box' style='padding:3px; width:350px;cursor:default'>Web form built with <a style='text-decoration:none;' href='http://www.simfatic.com'>Simfatic Forms simple wysiwyg form builder</a>.</div>
      </form>
