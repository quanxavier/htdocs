...
Registration_FormValidator.addValidation("image",{file_extn:"jpg;gif;bmp;png;tiff",message:"Allowed files types are: jpg;gif;bmp;png;tiff"} );
Registration_FormValidator.addValidation("image",{req_file:true,message:"File upload is required for Image"} );
...
Registration_FormValidator.addValidation("Age",{greaterthan:"6.00",message:"The value of Age should be greater than 6.00"} );
Registration_FormValidator.addValidation("Age",{lessthan:"17.00",message:"The value of Age should be less than 17.00"} );
Registration_FormValidator.addValidation("DOB",{required:true,message:"Please fill in DOB"} );
Registration_FormValidator.addValidation("DOB",{before_date:"FixedDate(2010-8-4)",message:"The date DOB should be before 2010 August 4"} );
Registration_FormValidator.addValidation("DOB",{after_date:"FixedDate(2000-8-5)",message:"The date DOB should be after 2000 August 5"} );
