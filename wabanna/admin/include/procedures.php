...
class FGMembersite
{
     ...
     function AddCamperInfo()
    {
     ...
     if(isset($_POST['submitted']))
            ...
            header("Location: Camp_Health_Form.php");
   ...
   $result = mysqli_query($connection, $qry);
      ...
      $week = $row['week'];
        ...
        if($Gender == 'male' && $Age <= '16' && $Age >= '12' ) {
            ...
            header("Location: Age_Error.html");
        }
   ...
   $qry =  "DELETE FROM camper_info where camper_id = '$id' ";
    ...
    function Add_Health_Form()
    {
      if(!isset($_POST['submitted']))
        ...
        $id = $_SESSION['camper_id'];
        $qry = "Update camper_info Set health_form_confirm='yes' Where camper_id  = $id ";
        if(!mysql_query( $qry,$this->connection))
        {
            $this->HandleDBError("Error inserting data to the table\nquery:$qry");
            return false;
    ...
    function CreateTable()
    {
		...
		"yes_no VARCHAR(10) NOT NULL ," .
                "consent_form_confirm VARCHAR(10) NOT NULL ," .
                "health_form_confirm VARCHAR(10) NOT NULL ," .
                "week_photo_confirm VARCHAR(10) NOT NULL ," .
        ...
        $qry = "Create Table health_form ("
                ...
                . "FirstName_e_contact VARCHAR (200) NOT NULL,"
                . "LastName_e_contact VARCHAR (200) NOT NULL,"
                . "Relationship VARCHAR (200) NOT NULL,"
                . "Phone_e_contact VARCHAR (200) NOT NULL,"
                . "Doctor VARCHAR (200) NOT NULL,"
                . "Phone_Doctor VARCHAR (200) NOT NULL,"
                ...
                . "IMUN_1 VARCHAR (200) NOT NULL,"
                . "IMUN_2 VARCHAR (200) NOT NULL,"
                . "IMUN_3 VARCHAR (200) NOT NULL,"
                . "IMUN_4 VARCHAR (200) NOT NULL,"
                . "IMUN_5 VARCHAR (200) NOT NULL,"
                . "IMUN_6 VARCHAR (200) NOT NULL,"
                . "IMUN_7 VARCHAR (200) NOT NULL,"
                . "IMUN_8 VARCHAR (200) NOT NULL,"
                . "IMUN_9 VARCHAR (200) NOT NULL,"
                . "IMUN_10 VARCHAR (200) NOT NULL,"
                . "IMUN_11 VARCHAR (200) NOT NULL,"
                . "IMUN_12 VARCHAR (200) NOT NULL,"
        ...
        function InsertIntoDB(&$formvars)
    {
		...
		"' . $this->SanitizeForSQL($formvars['state_f']) . '",
                ...
                "' . $this->SanitizeForSQL($formvars['county_f']) . '",
		...
		"' . $this->SanitizeForSQL($formvars['state_m']) . '",
                ...
                "' . $this->SanitizeForSQL($formvars['county_m']) . '",
                "' . $_SESSION['camper_id'] . '"
                )';      
