         ...
         <div id='Consent_Form_outer_div' class='form_outer_div' style='width:1000px;height:1201px'>
            <div style='position:relative' id='Consent_Form_inner_div'>
               ...
               <div id='label_container'>
                  <div id='label'>Please read the consent form and agree to the terms and conditions. <br />Note: Don't forget to fill in your Health Insurance information<br /><font color="red"><?PHP echo "($Firstname $Lastname)";?></font><br /></div>
               </div>
