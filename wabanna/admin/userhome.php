...
<body>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Menu</h3>
		<ul class="toggle">
                    <li class="icn_new_article"><a href="camper_info.php">Add Camper</a></li>
      ...
      <tbody>
		...
		<header><h3 class="">Your enrollments</h3>
    		...
    		<li><a href="#tab2">Remove Camper</a></li>
                ...
                <li><a href="#tab4">Edit Camper</a></li>
		</ul>
		</header>
...
<?php
	...
	//$query = "SELECT * FROM camper_info left join week_photo on camper_info.camper_id = week_photo.camper_id where id_user = $id";
        $query = "SELECT * FROM camper_info left join week_photo on camper_info.camper_id = week_photo.camper_id left join consent_form on camper_info.camper_id = consent_form.camper_id ";
	$result = mysqli_query($connection, $query);
...
<?php
$id = $_SESSION['id_of_user'];
	$query = "SELECT * FROM camper_info left join week_photo on camper_info.camper_id = week_photo.camper_id ";
 ...
 <h4 class="alert_warning">Images need to be clear!</h4><br><br>
  ...
  <h4 class="alert_warning">We hope you enjoy this year!</h4>
                          ...
                          <form id='remove-camper' class='sfm_form' enctype='multipart/form-data' method='post' action='' accept-charset='UTF-8'>                   
                        <div id="tab4" class="tab_content"><br><br>
 <h4 class="alert_error">Once a camper is enrolled you may not edit the Date of Birth, Age, or Gender fields. </h4>
 <h4 class="alert_error">If you attempt to Edit Camper before all forms are completed Camper will be automatically deleted!</h4>
 <br><br>
 <div class="styled-select">
...
?>
  ...
  <h4 class="alert_warning">If you have entered this data incorrectly, please Remove Camper first and then click Add Camper!</h4>
